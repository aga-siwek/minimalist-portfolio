...
- **The Process:** 1. Initially, I used **random moves** (only checking for empty cells), which was too easy. 2. Then, I added **logic-based rules** (`if` statements) to react to immediate threats (e.g., blocking a win). 3. Finally, I implemented the **Minimax algorithm**, allowing the AI to predict future moves.
